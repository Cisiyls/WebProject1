...
public static void main(String[] args) {
     ...
     try {
       ...
       //Step 2: drop tables in order of user_visit_history, users, restaurants
          ...
          sql = "CREATE TABLE USER_VISIT_HISTORY "
           ...
           BufferedReader reader = new BufferedReader(new FileReader(
                   ...
                   "D:\\LaiOffer\\Project\\software\\Yelp\\yelp_dataset_challenge_academic_dataset\\yelp_academic_dataset_business.json"));
